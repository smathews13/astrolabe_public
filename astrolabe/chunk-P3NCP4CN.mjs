...
function genieAccountingTile(accounting, reason) {
  if (!accounting) {
    return {
      id: "genie:charged",
  ...
  return {
    ...
    pricing,
    unavailable: period.paidUsd === null ? "Charged Genie DBUs are measured, but USD is unavailable because pricing is incomplete." : "",
    remedy: "",
