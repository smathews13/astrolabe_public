...
// ../../.wt-chart-readonly/player-insights-agent/node_modules/@opentelemetry/api-logs/build/src/types/LogRecord.js
var require_LogRecord = __commonJS({
  "../../.wt-chart-readonly/player-insights-agent/node_modules/@opentelemetry/api-logs/build/src/types/LogRecord.js"(exports) {
    "use strict";
...
// ../../.wt-chart-readonly/player-insights-agent/node_modules/@opentelemetry/api-logs/build/src/NoopLogger.js
var require_NoopLogger = __commonJS({
  "../../.wt-chart-readonly/player-insights-agent/node_modules/@opentelemetry/api-logs/build/src/NoopLogger.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// ../../.wt-chart-readonly/player-insights-agent/node_modules/@opentelemetry/api-logs/build/src/NoopLoggerProvider.js
var require_NoopLoggerProvider = __commonJS({
  "../../.wt-chart-readonly/player-insights-agent/node_modules/@opentelemetry/api-logs/build/src/NoopLoggerProvider.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// ../../.wt-chart-readonly/player-insights-agent/node_modules/@opentelemetry/api-logs/build/src/ProxyLogger.js
var require_ProxyLogger = __commonJS({
  "../../.wt-chart-readonly/player-insights-agent/node_modules/@opentelemetry/api-logs/build/src/ProxyLogger.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// ../../.wt-chart-readonly/player-insights-agent/node_modules/@opentelemetry/api-logs/build/src/ProxyLoggerProvider.js
var require_ProxyLoggerProvider = __commonJS({
  "../../.wt-chart-readonly/player-insights-agent/node_modules/@opentelemetry/api-logs/build/src/ProxyLoggerProvider.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// ../../.wt-chart-readonly/player-insights-agent/node_modules/@opentelemetry/api-logs/build/src/platform/node/globalThis.js
var require_globalThis = __commonJS({
  "../../.wt-chart-readonly/player-insights-agent/node_modules/@opentelemetry/api-logs/build/src/platform/node/globalThis.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// ../../.wt-chart-readonly/player-insights-agent/node_modules/@opentelemetry/api-logs/build/src/platform/node/index.js
var require_node = __commonJS({
  "../../.wt-chart-readonly/player-insights-agent/node_modules/@opentelemetry/api-logs/build/src/platform/node/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports._globalThis = void 0;
...
// ../../.wt-chart-readonly/player-insights-agent/node_modules/@opentelemetry/api-logs/build/src/platform/index.js
var require_platform = __commonJS({
  "../../.wt-chart-readonly/player-insights-agent/node_modules/@opentelemetry/api-logs/build/src/platform/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports._globalThis = void 0;
...
// ../../.wt-chart-readonly/player-insights-agent/node_modules/@opentelemetry/api-logs/build/src/internal/global-utils.js
var require_global_utils = __commonJS({
  "../../.wt-chart-readonly/player-insights-agent/node_modules/@opentelemetry/api-logs/build/src/internal/global-utils.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// ../../.wt-chart-readonly/player-insights-agent/node_modules/@opentelemetry/api-logs/build/src/api/logs.js
var require_logs = __commonJS({
  "../../.wt-chart-readonly/player-insights-agent/node_modules/@opentelemetry/api-logs/build/src/api/logs.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// ../../.wt-chart-readonly/player-insights-agent/node_modules/@opentelemetry/api-logs/build/src/index.js
var require_src = __commonJS({
  "../../.wt-chart-readonly/player-insights-agent/node_modules/@opentelemetry/api-logs/build/src/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// ../../.wt-chart-readonly/player-insights-agent/node_modules/picocolors/picocolors.js
var require_picocolors = __commonJS({
  "../../.wt-chart-readonly/player-insights-agent/node_modules/picocolors/picocolors.js"(exports, module) {
    var p = process || {};
    var argv = p.argv || [];
    var env = p.env || {};
...
// ../../.wt-chart-readonly/player-insights-agent/node_modules/@databricks/appkit/dist/utils/path-exclusions.js
...
function shouldIgnoreRequest(request) {
  ...
  return shouldExcludePath(path2);
}
function shouldExcludePath(path2) {
  if (typeof path2 !== "string") return false;
...
// ../../.wt-chart-readonly/player-insights-agent/node_modules/@databricks/appkit/dist/logging/sampling.js
...
// ../../.wt-chart-readonly/player-insights-agent/node_modules/@databricks/appkit/dist/logging/wide-event.js
var WideEvent = class {
  data;
  startTime;
...
// ../../.wt-chart-readonly/player-insights-agent/node_modules/@databricks/appkit/dist/logging/wide-event-emitter.js
var import_api_logs = __toESM(require_src(), 1);
var WideEventEmitter = class {
  logger = import_api_logs.logs.getLogger("appkit", "1.0.0");
  /**
  ...
  */
  getSeverityNumber(event) {
    if (event.error) return import_api_logs.SeverityNumber.ERROR;
    if (event.status_code) {
      if (event.status_code >= 500) return import_api_logs.SeverityNumber.ERROR;
      if (event.status_code >= 400) return import_api_logs.SeverityNumber.WARN;
    }
    if (event.logs) {
      if (event.logs.some((log2) => log2.level === "error")) return import_api_logs.SeverityNumber.ERROR;
      if (event.logs.some((log2) => log2.level === "warn")) return import_api_logs.SeverityNumber.WARN;
    }
  ...
  */
  getSeverityText(event) {
    ...
    if (severityNumber >= import_api_logs.SeverityNumber.ERROR) return "ERROR";
    if (severityNumber >= import_api_logs.SeverityNumber.WARN) return "WARN";
    if (severityNumber >= import_api_logs.SeverityNumber.INFO) return "INFO";
    return "DEBUG";
  }
  /**
...
// ../../.wt-chart-readonly/player-insights-agent/node_modules/@databricks/appkit/dist/logging/logger.js
init_esm();
import { AsyncLocalStorage } from "node:async_hooks";
import { format } from "node:util";

// ../../.wt-chart-readonly/player-insights-agent/node_modules/obug/dist/core.js
...
function createDebug(namespace, options) {
  ...
  const debug = (...args) => {
    ...
    let index = 0;
    args[0] = args[0].replace(/%([a-z%])/gi, (match, format2) => {
      if (match === "%%") return "%";
      index++;
...
// ../../.wt-chart-readonly/player-insights-agent/node_modules/obug/dist/node.js
...
function createDebug2(namespace, options) {
  ...
  return createDebug(namespace, Object.assign(defaultOptions, { color }, options));
}
enable(process.env.DEBUG || "");

// ../../.wt-chart-readonly/player-insights-agent/node_modules/@databricks/appkit/dist/logging/logger.js
var eventStorage = new AsyncLocalStorage();
var eventsByRequest = /* @__PURE__ */ new WeakMap();
var emitter = new WideEventEmitter();
...
function createEventForRequest(req) {
  ...
  const path2 = (req.path || req.url || req.originalUrl)?.split("?")[0];
  wideEvent.set("method", req.method).set("path", path2);
  ...
  if (spanContext?.traceId) {
    ...
    createDebug2("appkit:logger:event", { useColors: true })("WideEvent created: %s %s (reqId: %s, traceId: %s)", req.method, path2, requestId.substring(0, 8), spanContext.traceId.substring(0, 8));
  }
...
function createLogger(scope) {
  const debug = createDebug2(`appkit:${scope}`, { useColors: true });
...
// ../../.wt-chart-readonly/player-insights-agent/node_modules/@databricks/appkit/dist/plugins/server/remote-tunnel/gate.js
var REMOTE_TUNNEL_ASSET_PREFIXES = [
  "/@vite/",
  "/@fs/",
...
function isRemoteTunnelAssetRequest(req) {
  ...
  return REMOTE_TUNNEL_ASSET_PREFIXES.some((prefix) => path2.startsWith(prefix));
}

// ../../.wt-chart-readonly/player-insights-agent/node_modules/@databricks/appkit/dist/plugins/server/utils.js
...
var APPKIT_CONFIG_SCRIPT_ID = "__appkit__";
var EMPTY_RUNTIME_CONFIG_JSON = JSON.stringify({
  appName: "",
  queries: {},
  endpoints: {},
  plugins: {}
});
var JSON_SCRIPT_ESCAPE_MAP = {
  "<": "\\u003c",
  ">": "\\u003e",
  "&": "\\u0026",
  "\u2028": "\\u2028",
