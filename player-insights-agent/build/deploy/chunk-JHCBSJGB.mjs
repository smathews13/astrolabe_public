...
function genieAccountingTiles(ids, accounting, reason) {
  ...
  const tiles = period.instances.map((instance) => {
    ...
    return {
      ...
      quality: instance.paidUsd === null ? "unknown" : instance.attribution.endsWith("-allocation") ? "estimate" : "real",
      ...
      remedy: "",
      note: instance.attribution.endsWith("-allocation") ? `Allocated by user-day execution or app-call share · billing through ${period.throughDay || "unavailable"}.` : `Matched by user-day Query History or app-run evidence to this configured space · billing through ${period.throughDay || "unavailable"}.`,
      evidence: { billingRows: null, astrolabeQueries: null },
