...
var ExperimentalSettingsSchema = external_exports.object({
  ...
  notebookAgentSync: external_exports.boolean().default(false)
});
var ExperimentalSettingsPatchSchema = external_exports.strictObject({
  ...
  notebookAgentSync: external_exports.boolean().optional()
});

// server/lib/experimental-settings-store.ts
var KEY = "app-global";
var EXPERIMENTAL_SETTINGS_TABLE = appTable("experimental_settings");
function withoutLegacySpIdentities(value) {
  if (!value || typeof value !== "object" || Array.isArray(value)) return value;
  const { spIdentities: _retired, ...settings } = value;
  return settings;
}
var STORE = {
